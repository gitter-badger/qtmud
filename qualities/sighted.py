...
import types
from qtmud.qualities import Physical,Renderable
            ...
            if Physical in thing.qualities:
                if hasattr(thing, 'location') and thing.location is not None:
                    if Renderable in thing.location.qualities:
                        ...
                        scene = ('Wherever you are, there\'s no visual '
                                 'way of observing it.')
                        thing.manager.log.debug('%s tried to look but their '
                                                'location is not Renderable.',
                                                thing.name)
                else:
